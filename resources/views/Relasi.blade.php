...
<body>
    <div class="relative flex size-full min-h-screen flex-col bg-black dark group/design-root overflow-x-hidden fade-in" style='font-family: "Plus Jakarta Sans", "Noto Sans", sans-serif;'>
        <div class="layout-container flex h-full grow flex-col">
            ...
            <div class="container">
                <h3 class="text-white text-xl mb-4 text-center">Struktur Perusahaan</h3>
                <div class="company-structure">
                    <!-- CEO / Main Leader -->
                    <div class="department">
                        <div class="department-title">CEO</div>
                    </div>

                    <!-- Departments -->
                    <div class="sub-departments">
                        <div class="sub-department">
                            <div class="department-title">Sales Department</div>
                        </div>
                        <div class="sub-department">
                            <div class="department-title">Marketing Department</div>
                        </div>
                        <div class="sub-department">
                            <div class="department-title">Finance Department</div>
                        </div>
                        <div class="sub-department">
                            <div class="department-title">Operations Department</div>
                        </div>
                    </div>
                </div>
            </div>
