    ...
    <div class="relative flex size-full min-h-screen flex-col bg-black dark group/design-root overflow-x-hidden fade-in" style='font-family: "Plus Jakarta Sans", "Noto Sans", sans-serif;'>
        <div class="layout-container flex h-full grow flex-col">
                ...
                <script>
                    ...
                    const salesChart = new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: 'Sales',
                                data: [25, 20, 15, 10, 2, 3],
                                backgroundColor: 'rgba(251, 191, 36, 0.8)', // Warna batang
                                borderColor: '#fbbf24',
                                borderWidth: 1
                            }]
                        },
                        options: {
                            scales: {
                                y: { // Menggunakan format terbaru untuk opsi skala
                                    beginAtZero: true
                                }
                            }
                        }
           ...
           <div class="info-section">
               ...
               <div class="info-box">
                   <div class="info-title">Laki-laki</div>
                   <div class="info-value">25</div>
               </div>
               <div class="info-box">
                   <div class="info-title">Perempuan</div>
                   <div class="info-value">20</div>
               </div>
               <div class="info-box">
                   <div class="info-title">Hanya berkunjung</div>
                   <div class="info-value">15</div>
               </div>
               <div class="info-box">
                   <div class="info-title">Membeli barang</div>
                   <div class="info-value">15</div>
               </div>
           </div>
