...
<head>
    ...
    <title>About Us - 58 Vape Store</title>
...
<body class="bg-black min-h-screen flex flex-col">
    <div class="relative flex-grow flex flex-col">
        ...
        <!-- About Us Section -->
        <div class="about-us-container py-10 px-10 flex-grow">
            <h3 class="text-white text-2xl mb-6 text-center">Tentang 58 Vape Store</h3>
            <div class="text-white text-lg mb-6">
                <p>58 Vape Store adalah destinasi utama Anda untuk berbagai produk vape terbaik. Kami menyediakan berbagai macam produk dari mod, pod, e-liquid, hingga aksesoris vape berkualitas tinggi. Dengan berbagai pilihan yang dapat memenuhi kebutuhan setiap penggemar vape, kami berkomitmen untuk memberikan pengalaman belanja yang terbaik.</p>
                <p class="mt-4">Misi kami adalah untuk terus menyediakan produk vape yang berkualitas dengan harga yang terjangkau, serta memberikan pelayanan pelanggan yang ramah dan profesional. Kami juga senantiasa mengikuti perkembangan tren terkini dalam dunia vape untuk memastikan Anda selalu mendapatkan produk terbaru.</p>
            </div>
            
            <h3 class="text-white text-xl mb-4">Kontak Kami</h3>
            <div class="text-white text-lg">
                <p>Email: support@58vapestore.com</p>
                <p>Telepon: +62 838 6367 6263</p>
                <p>Alamat: Jl.Banyuraden,Gamping,Sleman,Yogyakarta.</p>
            </div>
        </div>
    </div>
