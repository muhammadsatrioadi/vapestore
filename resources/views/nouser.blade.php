...
<body class="relative flex size-full min-h-screen flex-col bg-black dark group/design-root overflow-x-hidden" style='font-family: "Plus Jakarta Sans", "Noto Sans", sans-serif;'>
  ...
  <div class="flex items-center gap-6 text-[#FFFFFF]">
    ...
    <nav class="flex gap-4">
      <a class="text-sm font-medium leading-normal hover:underline" href="{{ url('user') }}"></a>
      <a class="text-sm font-medium leading-normal hover:underline" href="{{ url('listbarang') }}"></a>
      <a class="text-sm font-medium leading-normal hover:underline" href="{{ url('profil') }}"></a>
    </nav>
  </div>
  ...
  <div class="flex items-center justify-end gap-4 mt-4 md:mt-0 flex-1">
    ...
    <div class="flex gap-2">
      ...
      <button
        class="h-10 px-4 bg-[#333333] text-[#FFFFFF] text-sm font-bold rounded-xl hover:bg-blue-700"
    ...
    <!-- Profile Picture -->
    <div
      class="hidden md:block w-10 h-10 bg-center bg-no-repeat bg-cover rounded-full"
    ...
    <div id="promoCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-10">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="images/MOD-Centaurus-M200-Lost-Vape-2-762x400.jpg" alt="Category Image" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="text-lg font-bold text-gray-800">MOD Vape</h3>
                    <p class="text-sm text-gray-500 mt-2">Explore our collection of vape kits. High quality and reliable products!</p>
                    <a href="/login" class="text-[#fbbf24] text-sm font-semibold">Shop Now</a>
                </div>
            </div>

            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="images/14.png" alt="Category Image" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="text-lg font-bold text-gray-800">Liquids</h3>
                    <p class="text-sm text-gray-500 mt-2">Find a wide range of flavors for your vape experience.</p>
                    <a href="/login" class="text-[#fbbf24] text-sm font-semibold">Shop Now</a>
                </div>
            </div>

            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="images/17.png" alt="Category Image" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="text-lg font-bold text-gray-800">RDA for MOD</h3>
                    <p class="text-sm text-gray-500 mt-2">Upgrade your vaping experience with quality accessories.</p>
                    <a href="/login" class="text-[#fbbf24] text-sm font-semibold">Shop Now</a>
                </div>
            </div>

            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <img src="images/18.png" alt="Category Image" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h3 class="text-lg font-bold text-gray-800">Coils</h3>
                    <p class="text-sm text-gray-500 mt-2">Keep your vape kit in top condition with our replacement coils.</p>
                    <a href="/login" class="text-[#fbbf24] text-sm font-semibold">Shop Now</a>
                </div>
            </div>
        </div>
